package ru.alfa4.grpcplayground.sec09.validator;
...
public class RequestValidator {
  ...
  public static Optional<Status> validateAccount(int accountNumber) {
    ...
    return Optional.of(
        Status.INVALID_ARGUMENT.withDescription("account number should be between 1 and 10"));
  }
  ...
  public static Optional<Status> isAmountDivisibleBy10(int amount) {
    ...
    return Optional.of(
        Status.INVALID_ARGUMENT.withDescription("requested amount should be 10 multiples"));
  }
